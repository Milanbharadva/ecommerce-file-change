...
public class RelatedProductsAdapter extends RecyclerView.Adapter<RelatedProductsAdapter.ViewHolder> {
    ...
    private final ArrayList<RelatedProductsItem> mList;
    private String price = "";
    private String currency = "";
    private String currencyPosition = "";

    public RelatedProductsAdapter(Activity context, ArrayList<RelatedProductsItem> mList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        RelatedProductsItem viewAll = mList.get(position);
    ...
    private void callApiRemoveFavourite(RelatedProductsItem viewAll, HashMap<String, String> map, int position) {
    ...
    private void callApiFavourite(RelatedProductsItem viewAll, HashMap<String, String> map, int position) {
        Common.showLoadingProgress(context);
